 ...
 * @since       3.1
 */
class RedshopbLayoutHelper
{
	/**
	 * A default base path that will be used if none is provided when calling the render method.
	 * Note that LayoutFile itself will defaults to JPATH_ROOT . '/layouts' if no basePath is supplied at all
	 *
	 * @var    string
	 * @since  3.1
	 */
	...
	public static function render($layoutFile, $displayData = null, $basePath = '', $options = null)
	{
		...
		$layout         = new RedshopbLayoutFile($layoutFile, $basePath, $options);
