 ...
 * @since  2.0
 */
class RedshopbEntitiesCollection implements Countable, Iterator
{
	/**
	 * @var  array
	 */
	 ...
	 *
	 * @param   RedshopbEntity  $entity  Entity going to be added
	 *
	 * @return  self
	 */
	public function add(RedshopbEntity $entity)
	{
	 ...
	 *
	 * @return  mixed  RedshopbEntity | FALSE if no entities
	 */
	 ...
	 *
	 * @return  mixed  RedshopbEntity if item exists. Null otherwise
	 */
	 ...
	 *
	 * @param   integer         $id      Entity identifier
	 * @param   RedshopbEntity  $entity  Entity
	 *
	 * @return  self
	 */
	public function set($id, RedshopbEntity $entity)
	{
