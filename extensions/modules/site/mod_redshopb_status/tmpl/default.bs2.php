...
?>
	<div class="modRedshopbStatus row-fluid" id="modRedshopbStatus_<?php echo $module->id; ?>">
		<div class="span12">
			<?php if ($displayProfile): ?>
				<div class="modRedshopbStatusUserProfile row-fluid">
					<div class="span12">
						<span class="username"><?php echo $userDisplay; ?></span> -
							<form action="<?php echo Route::_('index.php?option=com_users'); ?>" method="post"
							class="form-inline">
	...
	<?php if ($showImportCart) : ?>
		<div class="modRedshopbStatus row-fluid">
			<div class="span12">
			...
			<?php if ($showMyPage) : ?>
				<div class="profile-link-status pull-right">
					<a class="btn btn-success"
						href="<?php echo RedshopbRoute::_('index.php?option=com_redshopb&view=mypage') ?>">
					...
					<form method="post"
						...
						<?php if ($companiesVendor == 'parent'): ?>
							<a href="javascript:void(0);"
								...
								class="btn btn-default btn-danger shop-changevendor">
						...
						<a href="javascript:void(0);"
							...
							class="btn btn-default btn-danger shop-changecustomer">
							<i class="icon-signout"></i>
