...
<div class="redcore redshopb_search<?php echo $moduleclassSfx ?>">
	<form action="<?php echo RedshopbRoute::_('index.php?option=com_redshopb&view=shop&layout=productlist'); ?>"
		  method="post" class="form-inline" id="searchForm">
		<div class="row">
			<div class="col-md-12">
		...
		<div class="row hidden">
			<div id="mod_redshopb_search_searchword-results" class="col-md-12">
			</div>
		</div>
