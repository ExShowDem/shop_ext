...
?>
	<ul class="nav redcore">
		...
		<?php endif; ?>
		<li class="dropdown">
			<a id="dropdown-shop" href="#" class="dropdown-toggle" data-toggle="dropdown">
			...
			<ul class="dropdown-menu" aria-labelledby="dropdown-shop">
				...
				<?php if (RedshopbHelperACL::allowDisplayView('users')) : ?>
					<li>
...
<?php endif; ?>
				...
				<?php
					...
					<li class="dropdown-submenu">
						...
						<ul class="dropdown-menu">
							...
							<li>
								<a href="<?php echo RedshopbRoute::_('index.php?option=com_redshopb&view=layout_list') ?>">
									<?php echo Text::_('COM_REDSHOPB_OVERRIDE_VIEWER_TITLE') ?>
								</a>
							</li>
						</ul>
					</li>
				...
				<?php
				if (RedshopbHelperACL::allowDisplayView('words')) : ?>
					<li>
