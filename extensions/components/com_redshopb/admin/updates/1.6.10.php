 ...
 * @since       1.6
 */
class Com_RedshopbUpdateScript_1_6_10
{
	/**
	...
	public function execute()
	{
		...
		$this->fillTableAliases('#__redshopb_template', 'Template', array('scope', 'name'));
		$this->fillTableAliases('#__redshopb_newsletter', 'Newsletter');
