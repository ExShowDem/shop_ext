 ...
 * @since       1.6.99
 */
class Com_RedshopbUpdateScript_1_6_109
{
	/**
	...
	public function execute()
	{
		...
		$newPermissions = array(
			'redshopb.order.place',
			'redshopb.shopprice.view'
		);
		...
		Factory::getApplication()->enqueueMessage(Text::_('COM_REDSHOPB_UPDATE_1_6_109_NEW_ACL'));
