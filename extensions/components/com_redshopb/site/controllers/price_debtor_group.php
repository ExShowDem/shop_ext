...
/**
 * Price debtor group Controller
 *
 * @package     Aesir.E-Commerce.Backend
 * @subpackage  Controllers
 * @since       1.0
 */
class RedshopbControllerPrice_Debtor_Group extends RedshopbControllerForm
{
	/**
	 * @var  string
	 */
	protected $text_prefix = 'COM_REDSHOPB_PRICE_DEBTOR_GROUP';
	...
	public function ajaxcompanies()
	{
		...
		$form->setValue('customer_ids', '', is_null($companies) ? array() : $companies);
