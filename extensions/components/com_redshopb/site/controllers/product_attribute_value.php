...
/**
 * Product Attribute Value Controller
 *
 * @package     Aesir.E-Commerce.Frontend
 * @subpackage  Controllers
 * @since       1.0
 */
class RedshopbControllerProduct_Attribute_Value extends RedshopbControllerForm
{
	/**
	 * @var  string
	 */
	protected $text_prefix = 'COM_REDSHOPB_PRODUCT_ATTRIBUTE_VALUE';
	...
	protected function getRedirectToItemRoute($append = null)
	{
		...
		$attributeId = $this->input->get('attribute_id', 0, 'int');

		if ($attributeId)
		{
			$redirectUrl .= '&attribute_id=' . (int) $attributeId;
		}
