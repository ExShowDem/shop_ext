...
{
	?>
	<div class="accordion" id="redshopb-signin-b2c-accordion">
	...
	class="accordion-body collapse <?php echo $this->defaultOpen == 'login' ? 'in' : ''; ?>">
...
if ($this->company->id)
{
	...
	<div class="accordion-group">
		...
		<div id="collapseRegister"
			 class="accordion-body collapse <?php echo $this->defaultOpen == 'register' ? 'in' : ''; ?>">
			<div class="accordion-inner">
				<?php
				echo RedshopbLayoutHelper::render(
					'user.register',
