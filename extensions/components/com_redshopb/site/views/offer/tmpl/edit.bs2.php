...
<script type="text/javascript">
	(function ($){
		$(window).bind("beforeunload", function(){
			if ($('div.offerproducts-content button.save-offer-items').length != 0 && !$('div.offerproducts-content button.save-offer-items').hasClass('disabled'))
			{
				...
				<form action="<?php echo $action; ?>" method="post" name="adminForm" id="adminForm"
					...
					<div class="container-fluid">
						<div class="row-fluid">
							...
							<div class="control-group expirationInputDiv">
								<div class="control-label">
							...
							<div class="control-group employee_id_class customer_id_class<?php
							...
							<div class="control-group department_id_class customer_id_class<?php
							...
							<div class="control-group company_id_class customer_id_class<?php
