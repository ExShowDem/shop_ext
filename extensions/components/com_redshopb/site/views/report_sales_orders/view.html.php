...
/**
 * Report Sales Orders View
 *
 * @package     Aesir.E-Commerce.Frontend
 * @subpackage  Views
 * @since       1.0
 */
class RedshopbViewReport_Sales_Orders extends RedshopbView
{
	/**
	 * @var  array
	 */
	...
	{
		$this->loadedModel = $this->getModel('report_sales_orders');
	...
	{
		return Text::_('COM_REDSHOPB_REPORT_SALES_ORDERS_TITLE');
	}
