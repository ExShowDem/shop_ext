		...
		<form class="adminForm redshopb-quickorder-form" action="<?php echo $action ?>" method="post" id="redshopb-quickorder-form">
				...
				<?php if (!empty($this->cartItems)) : ?>
					...
					<?php foreach ($this->cartItems as $item) : ?>
						...
						<tr id="quickorder-product-<?php echo $id; ?>">
							...
							<td>
								<button class="btn btn-mini shopping-cart-remove" type="button"
										data-tr="<?php echo $id; ?>"
				...
				<div class="col-md-6">
					...
					<div class="redshopb-quickorder-comments">
						<textarea name="comment"
								  placeholder="<?php echo Text::_('COM_REDSHOPB_QUICK_ORDER_COMMENT') ?>"
								  class="textarea input-block-level" rows="5"></textarea>
					</div>
				</div>
				<div class="col-md-6">
					<div class="row">
						<div class="col-md-6 redshopb-quickorder-vat-title">
					...
					<div class="row">
						<div class="col-md-6 redshopb-quickorder-totalprice-title">
					...
					<div class="redshopb-quickorder-buttons">
						<button class="btn btn-success pull-right btn-default" id="redshopb-quickorder-button"><i
			...
			<div>
				...
				<input type="hidden" name="<?php echo Session::getFormToken(); ?>" value="1"
					   id="redshopb-quickorder-tool-token"/>
			</div>
		</form>
	</div>
	<?php endif; ?>
