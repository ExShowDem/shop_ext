...
<div class="redshopb-company">
	...
	<div class="tab-content">
						...
						<div class="container-fluid">
							<div class="row">
								<div class="col-md-6 adapt-inputs">
									...
									<?php if (!$this->isNew && $fromCompanyView && $parentId) : ?>
								...
								<div class="row">
									...
									<div class="col-md-6 adapt-inputs">
										...
										if (!RedshopbHelperUser::isRoot()
											...
											&& $config->getInt('customer_tax_exempt_global', 0) == 1
										)
										{
										...
										<?php if ($config->getInt('customer_tax_exempt_global', 0) == 1): ?>
										<div class="control-group">
											<div class="control-label">
		...
		<?php
		if ($this->item->id || $this->anyRequired)
			:
		?>
		...
		?>
			...
			<div class="tab-pane" id="addresses">
				<div class="container-fluid">
					<div class="row addresses-content">
						<div class="spinner pagination-centered">
							<?php echo HTMLHelper::image('media/com_redshopb/images/ajax-loader.gif', '') ?>
						</div>
					</div>
			...
			<div class="tab-pane" id="salespersons">
				<div class="container-fluid">
					<div class="row salespersons-content">
						<div class="spinner pagination-centered">
							<?php echo HTMLHelper::image('media/com_redshopb/images/ajax-loader.gif', '') ?>
						</div>
					</div>
			...
			<div class="tab-pane" id="stockrooms">
				<div class="container-fluid">
					<div class="row stockrooms-content">
						<div class="spinner pagination-centered">
							<?php echo HTMLHelper::image('media/com_redshopb/images/ajax-loader.gif', '') ?>
						</div>
					</div>
