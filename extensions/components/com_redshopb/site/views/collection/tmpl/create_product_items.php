...
<div class="redshopb-collection-create-productitems">
	...
	<div class="row">
		<div class="pagination-centered">
			<button class="btn btn-lg btn-danger" onclick="Joomla.submitbutton('collection.createCancel')">
				<i class="icon-double-angle-left"></i>
				<?php echo Text::_('JTOOLBAR_BACK'); ?>
			</button>
			<button class="btn btn-g btn-success" onclick="Joomla.submitbutton('collection.createNext')">
	...
	<div id="collection-product-items">
		<div class="row collection-product-items-content">
	...
	<div class="row">
		<div class="pagination-centered">
			...
			<button class="btn btn-lg btn-success" onclick="Joomla.submitbutton('collection.createNext')">
				<?php echo Text::_('JEND'); ?>
				<i class="icon-double-angle-right"></i>
			</button>
		</div>
