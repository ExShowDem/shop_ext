		...
		<div class="row">
			...
			<div class="col-md-6 adapt-inputs">
				...
				<?php if ($isNew || (!$isNew && $this->form->getValue('customer_type') == 'employee')): ?>
					<div class="form-group employee_customer_id_class customer_id_class<?php
				...
				<?php if ($isNew || (!$isNew && $this->form->getValue('customer_type') == 'department')): ?>
					<div class="form-group department_customer_id_class customer_id_class<?php
				...
				<?php if ($isNew || (!$isNew && $this->form->getValue('customer_type') == 'company')): ?>
					<div class="form-group company_customer_id_class customer_id_class<?php
