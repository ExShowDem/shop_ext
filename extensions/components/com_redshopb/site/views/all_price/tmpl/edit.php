...
<div class="redshopb-all_price">
	<form action="<?php echo $action; ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-horizontal">
		...
		<div class="form-group product_type_id_class product_item_type_id_class type_id_class<?php
		...
		<div class="form-group product_item_type_id_class type_id_class<?php
		...
		<div class="form-group customer_price_sales_id_class sales_id_class<?php
		...
		<div class="form-group customer_price_group_sales_id_class sales_id_class<?php
		...
		<div class="form-group campaign_sales_id_class sales_id_class<?php
		...
		<div class="form-group" id="quantity_max">
			<div class="control-label">
