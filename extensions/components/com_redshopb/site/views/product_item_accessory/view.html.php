...
/**
 * Product Item Accessory View
 *
 * @package     Aesir.E-Commerce.Frontend
 * @subpackage  Views
 * @since       1.0
 */
class RedshopbViewProduct_Item_Accessory extends RedshopbView
{
	/**
	 * @var  Form
	 */
	...
	public function getToolbar()
	{
		...
		if (RedshopbHelperACL::getPermission('manage', 'product', array('edit', 'edit.own'), true))
		{
			...
			{
				$save         = RToolbarBuilder::createSaveButton('product_item_accessory.apply');
				$saveAndClose = RToolbarBuilder::createSaveAndCloseButton('product_item_accessory.save');
