...
<script type="text/javascript" language="javascript">
	jQuery(document).ready(function(){
		...
		jQuery('#myOfferModalReject').on('show.bs.modal', function () {
			var $invoker = jQuery(jQuery(this).data('trigger'));
			var source = $invoker.data('source');
			jQuery('#modalIdFieldReject').val(source);
		});
	});
</script>
<div class="redshopb-myoffers">
				...
				<div class="redshopb-myoffers-table">
					<table class="table table-striped table-hover footable js-redshopb-footable redshopb-footable toggle-circle-filled" id="addressList">
							...
							<tr>
								...
								<td>
									<div class="btn-group">
										...
										{
											?>
											<a class="btn btn-sm btn-success hasTooltip" href="#myOfferModal"  data-toggle="modal" role="button" data-source="<?php
						...
						echo Text::_('COM_REDSHOPB_OFFER_ACCEPT_LBL'); ?>">
										...
										{
											?>
											<a class="btn btn-sm btn-warning hasTooltip" href="#myOfferModalReject"  data-toggle="modal" role="button" data-source="<?php
											echo $item->id; ?>" data-original-title="<?php
											echo Text::_('COM_REDSHOPB_OFFER_REJECT_LBL'); ?>">
	...
	<?php echo RHtml::_(
		'vnrbootstrap.renderModal', 'myOfferModalReject',
		array(
			'title' => Text::_('COM_REDSHOPB_OFFER_REJECT_OFFER_LBL')
		),
		RedshopbLayoutHelper::render('myoffer.rejectform')
	); ?>
</div>
