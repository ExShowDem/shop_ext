 ...
 * @since       1.0
 */
class RedshopbViewStates extends RedshopbView
{
	/**
	 * @var  array
	 */
	...
	public function display($tpl = null)
	{
		...
		$this->stoolsOptions['searchField'] = 'search_states';
	...
	{
		return Text::_('COM_REDSHOPB_STATE_LIST_TITLE');
	}
	...
	public function getToolbar()
	{
		...
		{
			$delete = RToolbarBuilder::createStandardButton('states.delete', 'JTOOLBAR_DELETE', 'btn-danger', 'icon-trash');
