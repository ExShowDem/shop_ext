...
$action       = RedshopbRoute::_('index.php?option=com_redshopb&view=report_general_newsletter');
...
<div class="redshopb-report_general_newsletter">
	<form action="<?php echo $action; ?>" name="adminForm" class="adminForm form-horizontal" id="adminForm" method="post">
			...
			<div class="col-md-6">
				...
				echo RedshopbLayoutHelper::render(
					...
					array(
						'view' => $this,
						'options' => array(
							'searchField' => 'search_report_general_newsletter',
							'searchFieldSelector' => '#filter_search_report_general_newsletter',
							'limitFieldSelector' => '#list_report_general_newsletter_limit',
				...
				<?php echo RedshopbLayoutHelper::render(
					...
					array(
						...
						'options' => array(
							...
							'chartId' => 'reportGeneralNewsletterChart',
						)
					)
				); ?>
			</div>
		...
		<hr/>
		<?php endif; ?>
		<div class="redshopb-report_general_newsletter-table">
