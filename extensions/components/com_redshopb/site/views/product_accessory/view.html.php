...
/**
 * Product Accessory View
 *
 * @package     Aesir.E-Commerce.Frontend
 * @subpackage  Views
 * @since       1.0
 */
class RedshopbViewProduct_Accessory extends RedshopbView
{
	/**
	 * @var  Form
	 */
	...
	public function getTitle()
	{
		...
		$title = Text::_('COM_REDSHOPB_PRODUCT_ACCESSORY_FORM_TITLE');
	...
	public function getToolbar()
	{
		...
		if (RedshopbHelperACL::getPermission('manage', 'product', array('edit', 'edit.own'), true))
		{
			...
			{
				$save         = RToolbarBuilder::createSaveButton('product_accessory.apply');
				$saveAndClose = RToolbarBuilder::createSaveAndCloseButton('product_accessory.save');
