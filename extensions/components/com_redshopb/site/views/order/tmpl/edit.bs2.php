		...
		<div class="container-fluid">
			<div class="row-fluid">
				<div class="span6">
					...
					<?php foreach ($this->form->getFieldset($this->formFieldset) as $field) : ?>
						<?php if ($field->hidden) : ?>
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<?php if ($field->fieldname == 'total_price'): ?>
				...
				<div class="span6">
					<div class="well">
						...
						<?php if (isset($this->item->delivery_address_name2)) :?>
							<p><?php echo $this->item->delivery_address_name2; ?></p>
						<?php endif;?>
						<p><?php echo $this->item->delivery_address_address; ?></p>

						<?php if (isset($this->item->delivery_address_address2)) :?>
					...
					<?php if (!empty($this->item->payment_name)) : ?>
					<div class="well">
						<h5><?php echo Text::_('COM_REDSHOPB_ORDER_PAYMENT_METHOD'); ?></h5><hr />
						<?php $payment = RApiPaymentHelper::getPaymentByExtensionId('com_redshopb', $this->item->id); ?>
						<p>
						...
						<?php endforeach; ?>
							...
							<?php if (in_array($this->item->status, array(0, 2, 3)) && $payment) : ?>
...
<?php if (in_array($this->item->status, array(0, 2, 3))) : ?>
<div class="hidden">
