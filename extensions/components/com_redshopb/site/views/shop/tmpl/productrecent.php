...
$action             = RedshopbRoute::_('index.php?option=com_redshopb&view=shop&layout=productrecent');
$showAs             = $app->getUserState('shop.show.productrecent.ProductsAs', 'list');
			...
			<div class="col-md-12">
				<div class="container-fluid">
					<div class="row">
						...
						$showAsURL     = 'index.php?option=com_redshopb&view=shop&layout=productrecent';
						$cartPrefix    = 'productRecent';
