...
$action       = RedshopbRoute::_('index.php?option=com_redshopb&view=report_customers_new');
...
<div class="redshopb-report_customers_new">
	<form action="<?php echo $action; ?>" name="adminForm" class="adminForm form-horizontal" id="adminForm" method="post">
			...
			<div class="span6">
				...
				echo RedshopbLayoutHelper::render(
					...
					array(
						'view' => $this,
						'options' => array(
							'searchField' => 'search_report_customers_new',
							'searchFieldSelector' => '#filter_search_report_customers_new',
							'limitFieldSelector' => '#list_report_customers_new_limit',
				...
				<?php echo RedshopbLayoutHelper::render(
					...
					array(
						...
						'options' => array(
							...
							'chartId' => 'reportCustomersNewChart',
						)
					)
				); ?>
			</div>
		...
		<hr/>
		<?php endif; ?>
		<div class="redshopb-report_customers_new-table">
