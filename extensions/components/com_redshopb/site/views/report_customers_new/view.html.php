...
/**
 * Report Report Customers New View
 *
 * @package     Aesir.E-Commerce.Frontend
 * @subpackage  Views
 * @since       1.0
 */
class RedshopbViewReport_Customers_New extends RedshopbView
{
	/**
	 * @var  array
	 */
	...
	{
		$this->loadedModel = $this->getModel('report_customers_new');
	...
	{
		return Text::_('COM_REDSHOPB_REPORT_CUSTOMERS_NEW_TITLE');
	}
