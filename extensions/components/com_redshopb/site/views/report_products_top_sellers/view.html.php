...
/**
 * Report Products Top Sellers View
 *
 * @package     Aesir.E-Commerce.Frontend
 * @subpackage  Views
 * @since       1.0
 */
class RedshopbViewReport_Products_Top_Sellers extends RedshopbView
{
	/**
	 * @var  array
	 */
	...
	{
		$this->loadedModel = $this->getModel('report_products_top_sellers');
		...
		$this->viewType  = $this->loadedModel->getState('chart.report_view_type', 'number_of_items');
	...
	{
		return Text::_('COM_REDSHOPB_REPORT_PRODUCTS_TOP_SELLERS_TITLE');
	}
