...
$action       = RedshopbRoute::_('index.php?option=com_redshopb&view=report_products_top_sellers');
...
<div class="redshopb-report_products_top_sellers">
	<form action="<?php echo $action; ?>" name="adminForm" class="adminForm form-horizontal" id="adminForm" method="post">
			...
			<div class="col-md-6">
				...
				echo RedshopbLayoutHelper::render(
					...
					array(
						'view' => $this,
						'options' => array(
							'searchField' => 'search_report_products_top_sellers',
							'searchFieldSelector' => '#filter_search_report_products_top_sellers',
							'limitFieldSelector' => '#list_report_products_top_sellers_limit',
				...
				<?php echo RedshopbLayoutHelper::render(
					...
					array(
						...
						'options' => array(
							...
							'chartId' => 'reportProductsTopSellersChart',
						)
					)
				); ?>
			</div>
		...
		<hr/>
		<?php endif; ?>
		<div class="redshopb-report_products_top_sellers-table">
