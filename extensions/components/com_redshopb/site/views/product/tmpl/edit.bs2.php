	...
	<div class="span12">
		...
		<div class="tab-content">
			<form action="<?php echo $action;?>"
				...
				<?php if ($this->item->id):?>
					<div class="tab-pane" id="ordering">
						<div class="span12 ordering-content tab-content">
				...
				<div class="tab-pane" id="packaging">
					<div class="row-fluid">
						<div class="span12 packaging-content tab-content">
							<div class="control-group">
								<div class="control-label">
			...
			<div class="tab-pane " id="images">
				<?php if ($this->item->id) : ?>
					<form action="<?php echo $action;?>" method="post" name="imageForm" id="imageForm" class="form-horizontal" enctype="multipart/form-data">
						<div class="row-fluid images-content form-horizontal">
							<div class="span12">
								<div class="thumbnail">
									...
									<table class="table table-striped table-hover product-images-table <?php echo (!$this->images) ? 'hide' : ''; ?>">
										...
										<?php if ($this->images): ?>
											<?php foreach ($this->images as $image): ?>
												<tr>
													<?php echo  RedshopbLayoutHelper::render('media.edit.imagerow', array('item' => $image));?>
												</tr>
											<?php endforeach; ?>
										<?php endif; ?>
										</tbody>
			...
			<div class="tab-pane " id="compositions">
				<div class="row-fluid ">
					<div class="span12 compositions-content tab-content">
						<div class="spinner pagination-centered">
							<?php echo HTMLHelper::image('media/com_redshopb/images/ajax-loader.gif', '') ?>
						</div>
					</div>
			...
			<div class="tab-pane" id="attributes">
				<div class="row-fluid">
					<div class="span12 attributes-content tab-content">
						<div class="spinner pagination-centered">
							<?php echo HTMLHelper::image('media/com_redshopb/images/ajax-loader.gif', '') ?>
						</div>
					</div>
			...
			<div class="tab-pane" id="combinations">
				<div class="row-fluid">
					<div class="span12 combinations-content tab-content">
						<div class="spinner pagination-centered">
							<?php echo HTMLHelper::image('media/com_redshopb/images/ajax-loader.gif', '') ?>
						</div>
					</div>
			...
			<div class="tab-pane" id="tableprices">
				<div class="row-fluid">
					<div class="span12 tableprices-content tab-content">
						<div class="spinner pagination-centered">
							<?php echo HTMLHelper::image('media/com_redshopb/images/ajax-loader.gif', '') ?>
						</div>
					</div>
			...
			<div class="tab-pane" id="prices">
				<div class="row-fluid">
					<div class="span12 prices-content tab-content">
						<div class="spinner pagination-centered">
							<?php echo HTMLHelper::image('media/com_redshopb/images/ajax-loader.gif', '') ?>
						</div>
					</div>
			...
			<div class="tab-pane" id="stock">
				<div class="row-fluid">
					<div class="span12 stock-content tab-content">
						<div class="spinner pagination-centered">
							<?php echo HTMLHelper::image('media/com_redshopb/images/ajax-loader.gif', '') ?>
						</div>
					</div>
			...
			<div class="tab-pane" id="collections">
				<div class="row-fluid">
					<div class="span12 collections-content tab-content">
						<div class="spinner pagination-centered">
							<?php echo HTMLHelper::image('media/com_redshopb/images/ajax-loader.gif', '') ?>
						</div>
					</div>
			...
			<div class="tab-pane" id="descriptions">
				<div class="row-fluid">
					<div class="span12 descriptions-content tab-content">
						<div class="spinner pagination-centered">
							<?php echo HTMLHelper::image('media/com_redshopb/images/ajax-loader.gif', '') ?>
						</div>
					</div>
			...
			<?php if (true == false): // Wash and care hidden until backlog review?>
				<div class="tab-pane" id="washcarespecs">
					<div class="row-fluid">
						<div class="span12 washcarespecs-content tab-content">
							<div class="spinner pagination-centered">
								<?php echo HTMLHelper::image('media/com_redshopb/images/ajax-loader.gif', '') ?>
							</div>
						</div>
			...
			<div class="tab-pane" id="accessories">
				<div class="row-fluid">
					<div class="span12 accessories-content tab-content">
						<div class="spinner pagination-centered">
							<?php echo HTMLHelper::image('media/com_redshopb/images/ajax-loader.gif', '') ?>
						</div>
					</div>
			...
			<div class="tab-pane" id="selectedaccessories">
				<div class="row-fluid">
					<div class="span12 selectedaccessories-content tab-content">
						<div class="spinner pagination-centered">
							<?php echo HTMLHelper::image('media/com_redshopb/images/ajax-loader.gif', '') ?>
						</div>
					</div>
			...
			<div class="tab-pane" id="complimentaryproducts">
				<div class="row-fluid">
					<div class="span12 complimentaryproducts-content tab-content">
						<div class="spinner pagination-centered">
							<?php echo HTMLHelper::image('media/com_redshopb/images/ajax-loader.gif', '') ?>
						</div>
					</div>
			...
			<div class="tab-pane" id="selectedcomplimentaryproducts">
				<div class="row-fluid">
					<div class="span12 selectedcomplimentaryproducts-content tab-content">
						<div class="spinner pagination-centered">
							<?php echo HTMLHelper::image('media/com_redshopb/images/ajax-loader.gif', '') ?>
						</div>
					</div>
