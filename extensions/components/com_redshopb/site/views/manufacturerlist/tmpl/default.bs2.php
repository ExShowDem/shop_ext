...
$action = RedshopbRoute::_('index.php?option=com_redshopb&view=manufacturerlist');

$columns       = $this->params !== null ? $this->params->get('columns', 4) : 4;
$itemSpanWidth = 'span' . $this->roundUp(12 / $columns);
$counter       = 0;
$mainSpanSize  = 12;
?>
	...
	<form action="<?php echo $action; ?>" name="adminForm" class="adminForm" id="adminForm" method="post">
		<div class="row-fluid">
			<?php if ($this->manufacturerListSidebar):
				...
				?>
			<div class="sidebar1 span<?php echo $spanSize;?>">
				<div class="row-fluid">
					<div class="span12">
			...
			<?php endif; ?>
			<div class="mainside span<?php echo $mainSpanSize;?>">
				<h1 class="page-title">
					...
					<div class="row-fluid">
						<?php foreach ($items as $i => $item): ?>
							<div class="<?php echo $itemSpanWidth; ?>">
								...
								<div class="redshopb-manufacturer-title span12">
									<a href="<?php echo RedshopbRoute::_('index.php?option=com_redshopb&view=shop&layout=manufacturer&id=' . $item->id);?>">
										<?php echo $item->name ?>
									</a>
								</div>
