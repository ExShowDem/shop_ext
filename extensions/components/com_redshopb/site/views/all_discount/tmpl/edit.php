...
<div class="redshopb-all_discount">
	<form action="<?php echo $action; ?>" method="post" name="adminForm" id="adminForm"
		...
		<div class="form-group product_type_id_class type_id_class<?php
		...
		<div class="form-group product_discount_group_type_id_class type_id_class<?php
		...
		<div class="form-group debtor_sales_id_class sales_id_class<?php
		...
		<div class="form-group debtor_discount_group_sales_id_class sales_id_class<?php
