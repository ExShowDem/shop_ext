...
$action       = RedshopbRoute::_('index.php?option=com_redshopb&view=report_products_low_stock');
...
<div class="redshopb-report_products_low_stock">
	<form action="<?php echo $action; ?>" name="adminForm" class="adminForm form-horizontal" id="adminForm" method="post">
			...
			<div class="col-md-6">
				...
				echo RedshopbLayoutHelper::render(
					...
					array(
						'view' => $this,
						'options' => array(
							'searchField' => 'search_report_products_low_stock',
							'searchFieldSelector' => '#filter_search_report_products_low_stock',
							'limitFieldSelector' => '#list_report_products_low_stock_limit',
				...
				<?php echo RedshopbLayoutHelper::render(
					...
					array(
						...
						'options' => array(
							...
							'chartId' => 'reportProductsLowStockChart',
						)
					)
				); ?>
			</div>
		...
		<hr/>
		<?php endif; ?>
		<div class="redshopb-report_products_low_stock-table">
