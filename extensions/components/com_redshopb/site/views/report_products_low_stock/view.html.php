 ...
 * @since       1.0
 */
class RedshopbViewReport_Products_Low_Stock extends RedshopbView
{
	/**
	 * @var  array
	 */
	...
	{
		$this->loadedModel = $this->getModel('report_products_low_stock');
	...
	{
		return Text::_('COM_REDSHOPB_REPORT_PRODUCTS_LOW_STOCK_TITLE');
	}
