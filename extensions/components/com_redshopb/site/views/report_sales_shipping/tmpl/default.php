...
$action       = RedshopbRoute::_('index.php?option=com_redshopb&view=report_sales_shipping');
...
<div class="redshopb-report_sales_shipping">
	<form action="<?php echo $action; ?>" name="adminForm" class="adminForm form-horizontal" id="adminForm" method="post">
			...
			<div class="col-md-6">
				...
				echo RedshopbLayoutHelper::render(
					...
					array(
						'view' => $this,
						'options' => array(
							'searchField' => 'search_report_sales_shipping',
							'searchFieldSelector' => '#filter_search_report_sales_shipping',
							'limitFieldSelector' => '#list_report_sales_shipping_limit',
				...
				<?php echo RedshopbLayoutHelper::render(
					...
					array(
						...
						'options' => array(
							...
							'chartId' => 'reportSalesShippingChart',
						)
					)
				); ?>
			</div>
		...
		<hr/>
		<?php endif; ?>
		<div class="redshopb-report_sales_shipping-table">
