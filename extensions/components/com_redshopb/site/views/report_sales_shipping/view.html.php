...
/**
 * Report Sales Shipping View
 *
 * @package     Aesir.E-Commerce.Frontend
 * @subpackage  Views
 * @since       1.0
 */
class RedshopbViewReport_Sales_Shipping extends RedshopbView
{
	/**
	 * @var  array
	 */
	...
	{
		$this->loadedModel = $this->getModel('report_sales_shipping');
	...
	{
		return Text::_('COM_REDSHOPB_REPORT_SALES_SHIPPING_TITLE');
	}
