...
/**
 * Report Products In Carts View
 *
 * @package     Aesir.E-Commerce.Frontend
 * @subpackage  Views
 * @since       1.0
 */
class RedshopbViewReport_Products_In_Carts extends RedshopbView
{
	/**
	 * @var  array
	 */
	...
	{
		$this->loadedModel = $this->getModel('report_products_in_carts');
	...
	{
		return Text::_('COM_REDSHOPB_REPORT_PRODUCTS_IN_CARTS_TITLE');
	}
