...
$action       = RedshopbRoute::_('index.php?option=com_redshopb&view=report_products_top_views');
...
<div class="redshopb-report_products_top_views">
	<form action="<?php echo $action; ?>" name="adminForm" class="adminForm form-horizontal" id="adminForm" method="post">
			...
			<div class="span6">
				...
				echo RedshopbLayoutHelper::render(
					...
					array(
						'view' => $this,
						'options' => array(
							'searchField' => 'search_report_products_top_views',
							'searchFieldSelector' => '#filter_search_report_products_top_views',
							'limitFieldSelector' => '#list_report_products_top_views_limit',
				...
				<?php echo RedshopbLayoutHelper::render(
					...
					array(
						...
						'options' => array(
							...
							'chartId' => 'reportProductsTopViewsChart',
						)
					)
				); ?>
			</div>
		...
		<hr/>
		<?php endif; ?>
		<div class="redshopb-report_products_top_views-table">
