...
/**
 * Report Products Top Views View
 *
 * @package     Aesir.E-Commerce.Frontend
 * @subpackage  Views
 * @since       1.0
 */
class RedshopbViewReport_Products_Top_Views extends RedshopbView
{
	/**
	 * @var  array
	 */
	...
	{
		$this->loadedModel = $this->getModel('report_products_top_views');
	...
	{
		return Text::_('COM_REDSHOPB_REPORT_PRODUCTS_TOP_VIEWS_TITLE');
	}
