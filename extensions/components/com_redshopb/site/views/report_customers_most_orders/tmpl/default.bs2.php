...
$action       = RedshopbRoute::_('index.php?option=com_redshopb&view=report_customers_most_orders');
...
<div class="redshopb-report_customers_most_orders">
	<form action="<?php echo $action; ?>" name="adminForm" class="adminForm form-horizontal" id="adminForm" method="post">
			...
			<div class="span6">
				...
				echo RedshopbLayoutHelper::render(
					...
					array(
						'view' => $this,
						'options' => array(
							'searchField' => 'search_report_customers_most_orders',
							'searchFieldSelector' => '#filter_search_report_customers_most_orders',
							'limitFieldSelector' => '#list_report_customers_most_orders_limit',
				...
				<?php echo RedshopbLayoutHelper::render(
					...
					array(
						...
						'options' => array(
							...
							'chartId' => 'reportCustomersMostOrdersChart',
						)
					)
				); ?>
			</div>
		...
		<hr/>
		<?php endif; ?>
		<div class="redshopb-report_customers_most_orders-table">
			<table class="table table-hover js-redshopb-footable table-condensed" id="reportList">
				...
				<?php if ($this->items): ?>
					...
					<?php foreach ($totalSums as $currency => $totalSum) :
						$this->getFormattedValue('currency', $currency);
						?>
						<tr>
							<th>
								<?php echo Text::_('COM_REDSHOPB_REPORT_TOTAL'); ?> (<?php echo $currency; ?>)
							</th>
							<?php foreach ($this->tableColumns as $cellKey => $cell) :
