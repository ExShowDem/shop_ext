...
/**
 * Report Customers Most Orders View
 *
 * @package     Aesir.E-Commerce.Frontend
 * @subpackage  Views
 * @since       1.0
 */
class RedshopbViewReport_Customers_Most_Orders extends RedshopbView
{
	/**
	 * @var  array
	 */
	...
	{
		$this->loadedModel = $this->getModel('report_customers_most_orders');
		...
		$this->chartType = $this->loadedModel->getState('chart.report_chart_type', 'Line');
		$this->viewType  = $this->loadedModel->getState('chart.report_view_type', 'number_of_orders');
	...
	{
		return Text::_('COM_REDSHOPB_REPORT_CUSTOMERS_MOST_ORDERS_TITLE');
	}
