...
<div class="row-fluid">
	<div class="btn-toolbar toolbar">
		...
		<div class="btn-group pull-right">
			<button class="btn" type="button" onclick="submitToFormat(this, 'csv');">
				<i class="icon-table"></i>
				<?php echo Text::_('LIB_REDCORE_CSV'); ?></button>
		</div>
		<div class="btn-group pull-right">
			<button class="btn" type="button" onclick="submitToFormat(this, 'xml');">
				<i class="icon-table"></i>
				<?php echo Text::_('COM_REDSHOPB_REPORTS_XML'); ?></button>
		</div>
		<div class="btn-group pull-right">
			<button class="btn" type="button" onclick="submitToFormat(this, 'json');">
				<i class="icon-download-alt"></i>
				<?php echo Text::_('COM_REDSHOPB_REPORTS_JSON'); ?></button>
		</div>
		<div class="btn-group pull-right">
			<button class="btn" type="button" onclick="printReport();">
