...
<div class="js-stools clearfix">
	<div class="clearfix">
		...
		<div class="btn-group pull-right">
			<button type="submit" class="btn btn-default hasTooltip" title="<?php echo RHtml::tooltipText('COM_REDSHOPB_REPORTS_SHOW_REPORT'); ?>">
				<i class="icon-table"></i>
				<?php echo Text::_('COM_REDSHOPB_REPORTS_SHOW_REPORT');?>
			</button>
		</div>
		<div class="btn-group pull-right">
			<button type="button" class="btn btn-default hasTooltip js-stools-btn-clear" title="<?php echo RHtml::tooltipText('COM_REDSHOPB_REPORTS_CLEAR_FILTERS'); ?>">
