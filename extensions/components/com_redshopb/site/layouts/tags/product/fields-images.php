...
if ($fieldsData):
	foreach ($fieldsData as $fieldData):
		if ($fieldData->type_alias == 'field-images'):
			if ($empty) : ?>
			...
			<tr>
				...
				if (!$href)
					...
					$href  = RedshopbHelperMedia::getFullMediaPath($params->get('internal_url', ''), $scope, 'field-images');
				}
					?>
					<div class="redshopb-field redshopb-field-field-images">
						<a title="<?php echo $fieldData->description; ?>" href="<?php echo $href; ?>" target="_blank">
							<i class="icon icon-picture"></i> <?php echo $fieldData->value; ?>
						</a>
					</div>
				</td>
			</tr>
