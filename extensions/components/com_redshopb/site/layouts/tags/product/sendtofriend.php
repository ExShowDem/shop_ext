...
<a class="btn btn-default hasTooltip" href="#sendToFriendModal" id="sendToFriendButton" title="<?php echo Text::_('COM_REDSHOPB_SHOP_SEND_LETTER'); ?>" role="button" data-toggle="modal">
	<i class="icon-envelope"></i>
</a>
<div id="sendToFriendModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="sendToFriendModalLabel" aria-hidden="true">
