...
if ($fieldsData):
	$groupedFieldsData = RedshopbHelperField::getFieldDataFieldGroups($fieldsData, RedshopbHelperField::FIELD_LOCAL_ONLY, $product->id);
	...
	foreach ($groupedFieldsData as $groupName => $groupedFieldData):
		...
		<tr>
			<?php if ($groupName): ?>
				<th class="productFieldGroup text-center" colspan="2">
					<?php echo $groupName; ?>
				</th>
			<?php endif; ?>
		</tr>
