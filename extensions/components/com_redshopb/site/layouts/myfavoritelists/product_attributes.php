...
<script type="text/javascript">
	...
	{
		jQuery('.myfavoritelist-product-attribute').on('change', function(event) {
	...
	<div class="form-group in-line">
		...
		<div class="controls">
			<?php echo HTMLHelper::_(
				...
				' class="myfavoritelist-product-attribute" attr-id="' . $attribute->id . '" is-main="' . $isMain . '"',
				'value',
				'text',
				$selected,
...
<input type="hidden" id="myfavoritelist-item-id" value="">
