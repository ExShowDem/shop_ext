...
<td>
	...
	<?php endif; ?>
		...
		<td>
			<a class="btn btn-sm btn-primary" href="index.php?option=com_redshopb&task=order.printPDF&id=<?php echo $item->id;?>" target="_blank" title="<?php echo Text::_('COM_REDSHOPB_PRINT'); ?>">
