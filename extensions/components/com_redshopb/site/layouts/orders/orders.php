...
?>
	...
	?>
			...
			?>
						<td>
							...
							<?php endif; ?>
								...
								<?php if ($isParent) : ?>
									<button class="btn btn-xs js-redshop-children"><i class="icon-chevron-down"></i></button>
								<?php endif; ?>
							</td>
			<?php
						break;
			...
			?>
						<td>
							<div class="btn-group">
								<button type="button" class="btn btn-sm btn-default" name="infoButton" title="<?php echo Text::_('COM_REDSHOPB_INFO'); ?>" data-order="<?php echo $item->id ?>">
									<i class="icon-info"></i>
								</button>
			...
			<div class="modal-dialog">
				...
				<div class="modal-body" style="overflow-y: visible !important;">
					<div class="container-fluid">
						...
						<div class="col-md-6" id="delivery">
