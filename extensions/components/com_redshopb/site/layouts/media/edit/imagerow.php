...
<td>
	<button
		class="btn btn-xs product-image-edit"
...
<td>
	<button
		class="btn btn-danger btn-xs product-image-remove"
		type="button"
		<?php echo ($data["isLockedByWebservice"] ? 'disabled' : '') ?>
		data-id="<?php echo $item->id; ?>">
...
<td>
	<button
		class="btn btn-xs  product-image-toggle <?php echo $buttonClass; ?>"
		type="button"
		<?php echo ($data["isLockedByWebservice"] ? 'disabled' : '') ?>
		data-id="<?php echo $item->id; ?>"
...
<td>
	<div class="thumbnail">
		<img alt="<?php echo RedshopbHelperThumbnail::safeAlt($item->alt) ?>"
