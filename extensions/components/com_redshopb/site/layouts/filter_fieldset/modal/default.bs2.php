...
?>
<div id="fieldsModal" class="modal hide fade">
	...
	<div class="modal-footer">
		<span id="searchFields" class="pull-left">
			<form id="searchForm" action="" class="form-search">
				...
				<button type="button" class="btn btn-small" onclick="searchFields()"><?php echo Text::_('JSEARCH');?></button>
				<button type="button" class="btn btn-small btn-danger" onclick="jQuery('#fields_search').val('');searchFields();"><?php echo Text::_('JCLEAR')?></button>
			</form>
		</span>
