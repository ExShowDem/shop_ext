	...
	<div class="redshopb-product_attribute-conversion_sets <?php echo $class ?>">
		<div class="row">
			<div class="col-md-10">
					...
					<div class="controls">
						...
						<?php if (empty($conversion->id)): ?>
							...
							<input type="text" disabled="disabled" class="input input-xlarge disabled" id="image-disable-<?php echo $uniqueId ?>"
								value="<?php echo HTMLHelper::_('COM_REDSHOPB_PRODUCT_ATTRIBUTE_CONVERSION_FOR_UPLOAD_IMAGE_SAVE_FIRST'); ?>" />
						<?php endif; ?>
				...
				<div class="form-group" id="group-<?php echo $uniqueId ?>">
					<div class="control-label">
