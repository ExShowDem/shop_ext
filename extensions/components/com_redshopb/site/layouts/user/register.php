			...
			<div class="row-fluid">
				<div class="span6">
					<div class="">
						...
						<?php if (!$registerCompany->get('b2c', 0)): ?>
							<div class="form-group b2c-company-infor">
								<div class="control-label">
							...
							<?php if ($departmentCompany->isValid()): ?>
								<div class="form-group b2c-department-infor">
									<div class="control-label">
									...
									<?php if (!$field->hidden): ?>
										<div class="control-label">
											...
											<?php if ($field->getAttribute('multiple_values') === "1") : ?>
												<button type="button"
														class="btn btn-success btn-sm clear pull-right add-field-row"
				...
				<div class="col-md-6">
					<div class="">
						...
						<div class="form-group bussiness-company-name-wrapper hidden">
							<?php
						...
						<div id="shippingaddress" class="js-registration-shipping-form-wrapper" style="display: none;">
							...
							<div class="form-group shippingStateGroup hide">
								<div class="control-label">
