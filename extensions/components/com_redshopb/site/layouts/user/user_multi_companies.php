...
$searchToolsOptions = array(
	"searchFieldSelector" => "#filter_search_user_multi_companies",
	"orderFieldSelector" => "#list_fullordering",
	"searchField" => "search_user_multi_companies",
	"limitFieldSelector" => "#list_user_multi_companies_limit",
...
<form action="<?php echo $action; ?>" name="<?php
	...
	if ($showToolbar)
	{
		echo RedshopbLayoutHelper::render('user_multi_companies.toolbar', $data);
	}
	?>
