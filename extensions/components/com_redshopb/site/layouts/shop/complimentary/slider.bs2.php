						...
						<div class="span12">
							<div class="pull-left">
								...
								<?php if ($showStockAs != 'hide') :
									...
									{
										echo '<span class="complimentaryProductNoStockFlag"><i class="icon icon-circle text-error"></i><span class="availableStock">' . Text::_('COM_REDSHOPB_PRODUCT_NO_STOCK') . '</span></span>';
									}
								endif;
						?>
