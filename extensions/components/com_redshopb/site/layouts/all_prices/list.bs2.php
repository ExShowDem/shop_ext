...
<form action="<?php echo $action; ?>" name="<?php echo $formName ?>" class="adminForm" id="<?php echo $formName ?>" method="post">
	...
	<?php if ($showToolbar):?>
		<div class="row-fluid">
			<div class="span12">
				<?php echo RedshopbLayoutHelper::render('all_prices.toolbar', $displayData);?>
			</div>
		</div>
	<?php endif; ?>
	<div class="row-fluid">
	...
	<?php else:?>
		<div class="row-fluid">
			<div class="span12">
				<table class="table table-striped table-hover footable js-redshopb-footable redshopb-footable toggle-circle-filled" id="allPricesList">
					<thead>
					<tr>
						<th>
