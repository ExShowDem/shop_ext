...
<?php endif ?>
				...
				<div class="col-md-6">
					...
					<?php if (!$isGuest): ?>
						<div class="row">
							<div class="col-md-12 well">
								<div class="row">
									<div class="col-md-12" id="redshopb-delivery-info-address">
			...
			<div class="col-md-6">
				...
				<div class="row">
					<div class="col-md-12 well">
						...
						<?php endif; ?>
						<div class="row">
							<div class="col-md-12" id="redshopb-delivery-info-comments">
	...
	<div id="redshopb-one-page-bottom-toolbar" class="row">
		<div class="col-md-12">
