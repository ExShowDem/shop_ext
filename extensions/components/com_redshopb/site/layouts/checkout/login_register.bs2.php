		...
		<div class="accordion" id="redshopb-delivery-b2c-accordion">
			<?php if ($showLoginForm):?>
				<div class="accordion-group">
					...
					<div id="collapseLogin" class="accordion-body collapse <?php echo 'login' == $active ? 'in' : ''; ?>">
				...
				<div class="accordion-group">
					...
					<div id="collapseRegister" class="accordion-body collapse <?php echo 'register' == $active ? 'in' : ''; ?>">
						<div class="accordion-inner">
