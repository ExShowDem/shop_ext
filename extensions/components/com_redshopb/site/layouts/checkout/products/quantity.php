...
$field->min  = $product->pkg_size > $field->min_sale ? $product->pkg_size : $product->min_sale;
...
if (!$isEmail)
{
	...
	$displayHtml = '<div class="input-group">' . $displayHtml . '<span class="add-on">' . $unitMeasureName . '</span></div>';
}
