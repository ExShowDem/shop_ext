...
$normalLink     = $options->get('useFormSubmit', false);
...
<div class="pagination pagination-toolbar clearfix" style="text-align: center;">
	...
	<?php if ($showPagesLinks) : ?>
		<?php $linkTemplate = ($normalLink === true) ? 'pagination.link' : 'tab.pagination.link'; ?>
		<ul class="pagination-list">
			<?php
				echo RedshopbLayoutHelper::render($linkTemplate, $pages['start']);
				echo RedshopbLayoutHelper::render($linkTemplate, $pages['previous']);
			?>
			<?php foreach ($pages['pages'] as $k => $page) : ?>

				<?php $output = RedshopbLayoutHelper::render($linkTemplate, $page); ?>
			...
			<?php endforeach; ?>
			<?php
				echo RedshopbLayoutHelper::render($linkTemplate, $pages['next']);
				echo RedshopbLayoutHelper::render($linkTemplate, $pages['end']); ?>
		</ul>
	<?php endif; ?>
