 ...
 * @since       1.0
 */
class PimGetDepartmentCode extends PimFunctionBase
{
	/**
	 ...
	 * @var  string
	 */
	public $syncName = 'erp.pim.departmentCode';

	/**
	 * @var string
	 */
	public $cronName = 'GetDepartmentCode';
	...
	public function processData($xml, $parentId = '')
	{
		...
		{
			if (!empty($obj['id']) && $obj['id'] == 'AfdKode')
			{
				$xmlGroup = $obj;
				break;
			}
