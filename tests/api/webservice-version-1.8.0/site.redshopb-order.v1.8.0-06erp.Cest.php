...
/**
 * Class SiteRedshopbOrder180erpCest
 * @since 2.8.0
 */
class SiteRedshopbOrder180erpCest
{
	...
	public function prepare(redshopb2b $I)
	{
		...
		$this->category['name'] = $this->faker->bothify('SiteRedshopbOrder180erpCest category ?##?');
		$this->category['id'] = (int)$I->createCategory($this->category['name']);

		$I->comment('I create a product');
		$this->product['name'] = $this->faker->bothify('SiteRedshopbOrder180erpCest product ?##?');
		...
		$this->company['name'] = $this->faker->bothify('SiteRedshopbOrder180erpCest company ?##?');
		$this->company['id'] = (int)$I->createCompany($this->company['name']);

		$I->comment('I prepare data to the delivery address');
		$this->deliveryAddress['name1'] = $this->faker->bothify('SiteRedshopbOrder180erpCest delivery_address ?##?');
