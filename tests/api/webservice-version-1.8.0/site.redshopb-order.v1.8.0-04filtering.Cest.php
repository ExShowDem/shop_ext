...
/**
 * Class SiteRedshopbOrder180filteringCest
 * @since 2.8.0
 */
class SiteRedshopbOrder180filteringCest
{
	...
	public function prepare(redshopb2b $I)
	{
		...
		$this->category['name'] = $this->faker->bothify('SiteRedshopbOrder180filteringCest category ?##?');
		$this->category['id'] = (int)$I->createCategory($this->category['name']);

		$I->comment('I create a product');
		$this->product['name'] = $this->faker->bothify('SiteRedshopbOrder180filteringCest product ?##?');
		...
		$this->companyA['name'] = $this->faker->bothify('SiteRedshopbOrder180filteringCest companyA ?##?');
		$this->companyA['id'] = (int)$I->createCompany($this->companyA['name']);

		$this->companyB['name'] = $this->faker->bothify('SiteRedshopbOrder180filteringCest companyB ?##?');
		$this->companyB['id'] = (int)$I->createCompany($this->companyB['name']);

		$I->comment('I prepare data for two delivery address');
		$this->deliveryAddressA['name1'] = $this->faker->bothify('SiteRedshopbOrder180filteringCest delivery_addressA ?##?');
		...
		$this->deliveryAddressB['name1'] = $this->faker->bothify('SiteRedshopbOrder180filteringCest delivery_addressB ?##?');
