...
class SiteRedshopbProduct100FilteringCest
{
	/**
	...
	public function prepare(Step\Api\redshopb2b $I)
	{
		...
		$this->productA['name'] = (string) $this->faker->bothify('SiteRedshopbProduct100FilteringCest product ?##?');
		$this->productA['sku']  = $this->faker->randomNumber(3);
		$this->productA['category_name'] = (string) $this->faker->bothify('SiteRedshopbProduct100FilteringCest category ?##?');
		$this->productA['category_id']  = (int) $I->createCategory($this->productA['category_name']);
		$this->productA['id'] = (int) $I->createProduct($this->productA['name'], $this->productA['sku'], $this->productA['category_id'], '1.0.0');

		$I->comment('I create a ProductB to be filtered by Category');
		$this->productB['name'] = (string) $this->faker->bothify('SiteRedshopbProduct100FilteringCest product ?##?');
		$this->productB['sku']  = $this->faker->randomNumber(3);
		$this->productB['category_name'] = (string) $this->faker->bothify('SiteRedshopbProduct100FilteringCest category ?##?');
		$this->productB['category_id']  = (int) $I->createCategory($this->productB['category_name']);
		$this->productB['id'] = (int) $I->createProduct($this->productB['name'], $this->productB['sku'], $this->productB['category_id'], '1.0.0');

		$I->comment('I create a ProductC to be filtered by Sku');
		$this->productC['name'] = (string) $this->faker->bothify('SiteRedshopbProduct100FilteringCest product ?##?');
		$this->productC['sku']  = $this->faker->randomNumber(3);
		$this->productC['category_name'] = (string) $this->faker->bothify('SiteRedshopbProduct100FilteringCest category ?##?');
		$this->productC['category_id']  = (int) $I->createCategory($this->productC['category_name']);
		$this->productC['id'] = (int) $I->createProduct($this->productC['name'], $this->productC['sku'], $this->productC['category_id'], '1.0.0');
	}
	...
	{
		$I->deleteProduct($this->productA['id'], '1.0.0');
		$I->deleteProduct($this->productB['id'], '1.0.0');
		$I->deleteProduct($this->productC['id'], '1.0.0');

		$I->deleteCategory($this->productA['category_id'], '1.0.0');
		$I->deleteCategory($this->productB['category_id'], '1.0.0');
		$I->deleteCategory($this->productC['category_id'], '1.0.0');
	}
}
