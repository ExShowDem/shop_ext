...
class SiteRedshopbCategory110tasksCest
{
	...
	public function taskPublish(Step\Api\redshopb2b $I)
	{
		...
		$categoryA['name']  = (string) $this->faker->bothify('SiteRedshopbCategory110tasksCest category ?##?');
		$categoryA['id'] = (int) $I->createCategory($categoryA['name'], '1.1.0');
		$I->unpublishCategory($categoryA['id'], '1.1.0');
	...
	public function taskUnpublish(Step\Api\redshopb2b $I)
	{
		...
		$categoryB['name']  = (string) $this->faker->bothify('SiteRedshopbCategory110tasksCest category ?##?');
		$categoryB['id'] = (int) $I->createCategory($categoryB['name'], '1.1.0');
		$I->publishCategory($categoryB['id'], '1.1.0');
		...
		$I->deleteCategory($categoryB['id'], '1.1.0');
	}
	...
	public function imageUploadAndImageRemove(Step\Api\redshopb2b $I)
	{
		...
		$categoryC['name'] = (string) $this->faker->bothify('SiteRedshopbCategory110TasksCest category ?##?');
		$categoryC['id'] = (int) $I->createCategory($categoryC['name'], '1.1.0');
		...
		$I->deleteCategory($categoryC['id'], '1.1.0');
	}
	...
	public function translateRemove(Step\Api\redshopb2b $I)
	{
		...
		$I->comment('I create a category to be translated');
		$categoryD['name']  = (string) $this->faker->bothify('SiteRedshopbCategory110tasksCest category ?##?');
		$categoryD['id'] = (int) $I->createCategory($categoryD['name'], '1.1.0');
		...
		$I->deleteCategory($categoryD['id'], '1.1.0');
	}
}
