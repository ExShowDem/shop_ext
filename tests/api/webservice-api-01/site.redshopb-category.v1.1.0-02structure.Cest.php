...
class SiteRedshopbCategory110StructureCest
{
	public function prepare(ApiTester $I)
	{
		$I->wantTo('POST a new category');
		$this->faker = Faker\Factory::create();
		$this->name  = $this->faker->bothify('SiteRedshopbCategory110StructureCest category ?##?');
		...
		$I->seeResponseContainsJson(
			[
				'_links'            => [
					'curies'                   => [
							0 => [
									'href'      => "$baseUrl/index.php?option=com_redshopb&view=category&webserviceVersion=1.1.0&webserviceClient=site&format=doc&api=Hal#{rel}",
									'title'     => 'Documentation',
					...
					'redshopb-category:list'   => [
							'href' => "$baseUrl/index.php?option=com_redshopb&view=category&webserviceVersion=1.1.0&webserviceClient=site&api=Hal",
					],
					'redshopb-category:self'   => [
							'href' => "$baseUrl/index.php?option=com_redshopb&view=category&webserviceVersion=1.1.0&webserviceClient=site&id=$this->id&api=Hal",
					],
