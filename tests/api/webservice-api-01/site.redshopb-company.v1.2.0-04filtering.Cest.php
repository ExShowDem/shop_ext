...
class SiteRedshopbCompany120FilteringCest
{
	/**
	...
	public function prepare(Step\Api\redshopb2b $I)
	{
		...
		$this->companyH['id'] = (int) $I->createCompany($this->companyH['name'], '1.2.0');
		$I->unpublishCompany($this->companyH['id'], '1.2.0');
	}
	...
	public function cleanUp(Step\Api\redshopb2b $I)
	{
		...
		$I->deleteCompany($this->companyB['id'], '1.2.0');
		$I->deleteCompany($this->companyA['id'], '1.2.0');
		$I->deleteCompany($this->companyC['id'], '1.2.0');
		$I->deleteCompany($this->companyD['id'], '1.2.0');
		$I->deleteCompany($this->companyE['id'], '1.2.0');
		$I->deleteCompany($this->companyF['id'], '1.2.0');
		$I->deleteCompany($this->companyG['id'], '1.2.0');
		$I->deleteCompany($this->companyH['id'], '1.2.0');
	}
}
