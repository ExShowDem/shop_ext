...
class SiteRedshopbCategory100FilteringCest
{
	/**
	...
	public function prepare(Step\Api\redshopb2b $I)
	{
		...
		$this->categoryA['name'] = (string) $this->faker->bothify('SiteRedshopbCategory100FilteringCest category ?##?');
		$this->categoryA['id'] = (int) $I->createCategory($this->categoryA['name'], '1.0.0');

		$I->comment('I create a CategoryB to be filtered by Company');
		$this->categoryB['name']  = (string) $this->faker->bothify('SiteRedshopbCategory100FilteringCest category ?##?');
		...
		$this->categoryC['name']  = (string) $this->faker->bothify('SiteRedshopbCategory100FilteringCest category ?##?');
		...
		$this->categoryD['name']  = (string) $this->faker->bothify('SiteRedshopbCategory100FilteringCest category ?##?');
		$this->categoryD['id'] = (int) $I->createCategory($this->categoryD['name'], '1.0.0');
		$I->unpublishCategory($this->categoryD['id'], '1.0.0');
	}
	...
	public function cleanUp(Step\Api\redshopb2b $I)
	{
		...
		$I->deleteCategory($this->categoryC['id'], '1.0.0');

		$I->deleteCategory($this->categoryA['id'], '1.0.0');
		$I->deleteCategory($this->categoryB['id'], '1.0.0');
		$I->deleteCategory($this->categoryD['id'], '1.0.0');
	}
}
