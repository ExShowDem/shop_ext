...
class SiteRedshopbDepartment100StructureCest
{
	public function prepare(\Step\Api\redshopb2b $I)
	{
		$I->wantTo('POST a new category');
		$this->faker = Faker\Factory::create();
		$this->name  = $this->faker->bothify('SiteRedshopbDepartment100StructureCest deparment ?##?');
					...
					[
						'curies' =>
							[
								0 =>
									[
										'href' => "$baseUrl/index.php?option=com_redshopb&view=department&webserviceVersion=1.0.0&webserviceClient=site&format=doc&api=Hal#{rel}",
										'title' => 'Documentation',
						...
						'redshopb-department:list' =>
							[
								'href' => "$baseUrl/index.php?option=com_redshopb&view=department&webserviceVersion=1.0.0&webserviceClient=site&api=Hal",
							],
						'redshopb-department:self' =>
							[
								'href' => "$baseUrl/index.php?option=com_redshopb&view=department&webserviceVersion=1.0.0&webserviceClient=site&id=$this->id&api=Hal",
							],
						'redshopb-company' =>
							[
						...
						'redshopb-department' =>
							[
								'href' => "$baseUrl/index.php?option=redshopb&view=department&webserviceVersion=1.0.0&webserviceClient=site&id=$this->parent_id&api=Hal",
