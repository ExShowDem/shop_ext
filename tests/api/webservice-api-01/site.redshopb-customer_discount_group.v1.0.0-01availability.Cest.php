...
class SiteRedshopbCustomer_discount_group100availabilityCest
{
	public function WebserviceIsAvailable(ApiTester $I)
	{
		...
		$I->sendGET('index.php'
			. '?option=redshopb&view=customer_discount_group'
			. '&api=Hal'
		...
		$I->seeHttpHeader('X-Webservice-name', 'redshopb-customer_discount_group');
