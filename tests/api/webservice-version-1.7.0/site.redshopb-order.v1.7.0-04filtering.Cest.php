...
/**
 * Class SiteRedshopbOrder170filteringCest
 * @since 2.8.0
 */
class SiteRedshopbOrder170filteringCest
{
	...
	public function prepare(redshopb2b $I)
	{
		...
		$this->category['name'] = $this->faker->bothify('SiteRedshopbOrder170filteringCest category ?##?');
		$this->category['id'] = (int)$I->createCategory($this->category['name']);

		$I->comment('I create a product');
		$this->product['name'] = $this->faker->bothify('SiteRedshopbOrder170filteringCest product ?##?');
		...
		$this->companyA['name'] = $this->faker->bothify('SiteRedshopbOrder170filteringCest companyA ?##?');
		$this->companyA['id'] = (int)$I->createCompany($this->companyA['name']);

		$this->companyB['name'] = $this->faker->bothify('SiteRedshopbOrder170filteringCest companyB ?##?');
		$this->companyB['id'] = (int)$I->createCompany($this->companyB['name']);

		$I->comment('I prepare data for two delivery address');
		$this->deliveryAddressA['name1'] = $this->faker->bothify('SiteRedshopbOrder170filteringCest delivery_addressA ?##?');
		...
		$this->deliveryAddressB['name1'] = $this->faker->bothify('SiteRedshopbOrder170filteringCest delivery_addressB ?##?');
