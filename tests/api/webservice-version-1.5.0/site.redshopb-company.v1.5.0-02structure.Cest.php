...
class SiteRedshopbCompany150StructureCest
{
	/**
	 * @param ApiTester $I
	 * @throws \Exception
		...
		$I->seeResponseContainsJson(
			[
				'_links'            => [
					'curies'                   => [
							0 => [
									'href'      => "$baseUrl/index.php?option=com_redshopb&view=company&webserviceVersion=1.5.0&webserviceClient=site&format=doc&api=Hal#{rel}",
									'title'     => 'Documentation',
					...
					'redshopb-company:list'   => [
							'href' => "$baseUrl/index.php?option=com_redshopb&view=company&webserviceVersion=1.5.0&webserviceClient=site&api=Hal",
					],
					'redshopb-company:self'   => [
							'href' => "$baseUrl/index.php?option=com_redshopb&view=company&webserviceVersion=1.5.0&webserviceClient=site&id=2&api=Hal",
					],
					'redshopb-country' =>
						[
