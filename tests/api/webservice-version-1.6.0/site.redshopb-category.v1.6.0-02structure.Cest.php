...
class SiteRedshopbCategory160StructureCest
{
	/**
	 * @param ApiTester $I
	 * @throws Exception
	...
	public function prepare(ApiTester $I)
	{
		...
		$this->name  = $this->faker->bothify('SiteRedshopbCategory160StructureCest category ?##?');
		...
		$I->seeResponseContainsJson(
			[
				'_links'            => [
					'curies'                   => [
							0 => [
									'href'      => "$baseUrl/index.php?option=com_redshopb&view=category&webserviceVersion=1.6.0&webserviceClient=site&format=doc&api=Hal#{rel}",
									'title'     => 'Documentation',
					...
					'redshopb-category:list'   => [
							'href' => "$baseUrl/index.php?option=com_redshopb&view=category&webserviceVersion=1.6.0&webserviceClient=site&api=Hal",
					],
					'redshopb-category:self'   => [
							'href' => "$baseUrl/index.php?option=com_redshopb&view=category&webserviceVersion=1.6.0&webserviceClient=site&id=$this->id&api=Hal",
					],
