...
/**
 * Class SiteRedshopbOrder160erpCest
 * @since 2.8.0
 */
class SiteRedshopbOrder160erpCest
{
	...
	public function prepare(redshopb2b $I)
	{
		...
		$this->category['name'] = $this->faker->bothify('SiteRedshopbOrder160erpCest category ?##?');
		$this->category['id'] = (int)$I->createCategory($this->category['name']);

		$I->comment('I create a product');
		$this->product['name'] = $this->faker->bothify('SiteRedshopbOrder160erpCest product ?##?');
		...
		$this->company['name'] = $this->faker->bothify('SiteRedshopbOrder160erpCest company ?##?');
		$this->company['id'] = (int)$I->createCompany($this->company['name']);

		$I->comment('I prepare data to the delivery address');
		$this->deliveryAddress['name1'] = $this->faker->bothify('SiteRedshopbOrder160erpCest delivery_address ?##?');
