...
/**
 * Class SiteRedshopbDelivery_address120filteringCest
 * @since 2.5.0
 */
class SiteRedshopbDelivery_address120filteringCest
{
	...
	public function prepare(\Step\Api\redshopb2b $I)
	{
		...
		$this->addressA_name1 = $this->faker->bothify('SiteRedshopbDelivery_Address120FilteringCest addressA ?##?');
		...
		$this->addressB_name1 = $this->faker->bothify('SiteRedshopbDelivery_Address120FilteringCest addressB ?##?');
		...
		$this->addressC_name1 = $this->faker->bothify('SiteRedshopbDelivery_Address120FilteringCest addressC ?##?');
		...
		$this->addressD_name1 = $this->faker->bothify('SiteRedshopbDelivery_Address120FilteringCest addressD ?##?');
	...
	{
		$I->webserviceCrudDelete('delivery_address', "$this->addressA_id", '1.2.0');
		$I->webserviceCrudDelete('delivery_address', "$this->addressB_id", '1.2.0');
		$I->webserviceCrudDelete('delivery_address', "$this->addressC_id", '1.2.0');
		$I->webserviceCrudDelete('delivery_address', "$this->addressD_id", '1.2.0');
	}
}