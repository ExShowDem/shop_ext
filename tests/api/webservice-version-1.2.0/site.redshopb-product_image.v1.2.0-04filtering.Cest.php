...
/**
 * Class SiteRedshopbProductImage120FilteringCest
 * @since 2.8.0
 */
class SiteRedshopbProductImage120FilteringCest
{
	...
	public function prepare(redshopb2b $I)
	{
		...
		$this->category['name'] = $this->faker->bothify('SiteRedshopbProductImage120FilteringCest category ?##?');
		$this->category['id'] = (int) $I->createCategory($this->category['name'], '1.6.0');

		$I->comment('I create a product');
		$this->product['name'] = $this->faker->bothify('SiteRedshopbProductImage120FilteringCest product ?##?');
		...
		$this->productImageB['name'] = $this->faker->bothify('SiteRedshopbProductImage120FilteringCest productImageB ?##?');
