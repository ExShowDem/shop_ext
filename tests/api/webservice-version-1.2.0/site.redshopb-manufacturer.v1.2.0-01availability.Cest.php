 ...
 */
class SiteRedshopbManufacturer120AvailabilityCest
{
	/**
	 * @param ApiTester $I
	 */
	...
	{
		$I->wantTo("check the availability of the webservice manufacturer");
		...
		$I->seeHttpHeader('X-Webservice-name', 'redshopb-manufacturer');
