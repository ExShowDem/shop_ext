...
/**
 * Class SiteRedshopbDelivery_address120structureCest
 * @since 2.5.0
 */
class SiteRedshopbDelivery_address120structureCest
{
	...
	public function prepare(\Step\Api\redshopb2b $I)
	{
		...
		$this->name1 = $this->faker->bothify('SiteRedshopbDelivery_Address120StructureCest address ?##?');
		...
		$I->seeResponseContainsJson(
			[
				'_links' => [
					'curies' => [
						0 => [
							'href'      => "$baseUrl/index.php?option=com_redshopb&view=delivery_address&webserviceVersion=1.2.0&webserviceClient=site&format=doc&api=Hal#{rel}",
							'title'     => 'Documentation',
					...
					'redshopb-delivery_address:list' => [
						'href'  => "$baseUrl/index.php?option=com_redshopb&view=delivery_address&webserviceVersion=1.2.0&webserviceClient=site&api=Hal"
					],
					'redshopb-delivery_address:self' => [
						'href'  => "$baseUrl/index.php?option=com_redshopb&view=delivery_address&webserviceVersion=1.2.0&webserviceClient=site&id=$this->id&api=Hal"
					],
					'redshopb-country' => [
