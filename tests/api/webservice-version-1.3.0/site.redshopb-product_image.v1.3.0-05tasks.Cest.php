...
/**
 * Class SiteRedshopbProductImage130TasksCest
 * @since 2.8.0
 */
class SiteRedshopbProductImage130TasksCest
{
	...
	public function prepare(redshopb2b $I)
	{
		...
		$this->productImage['name'] = $this->faker->bothify('SiteRedshopbProductImage130TasksCest product image ?##?');
		$this->productImage['erp_id'] = $this->faker->bothify('?##?');

		$I->comment('I create a category');
		$this->category['name'] = $this->faker->bothify('SiteRedshopbProductImage130TasksCest category ?##?');
		$this->category['id'] = (int) $I->createCategory($this->category['name'], '1.6.0');

		$I->comment('I create a product');
		$this->product['name'] = $this->faker->bothify('SiteRedshopbProductImage130TasksCest product ?##?');
