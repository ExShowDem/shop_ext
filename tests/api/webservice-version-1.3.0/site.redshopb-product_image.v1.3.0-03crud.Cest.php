...
/**
 * Class SiteRedshopbProductImage130CrudCest
 * @since 2.8.0
 */
class SiteRedshopbProductImage130CrudCest
{
	...
	public function prepare(redshopb2b $I)
	{
		...
		$this->productImage['name'] = $this->faker->bothify('SiteRedshopbProductImage130CrudCest product image ?##?');
		$this->productImage['erp_id'] = $this->faker->bothify('?##?');

		$I->comment('I create a category');
		$this->category['name'] = $this->faker->bothify('SiteRedshopbProductImage130CrudCest category ?##?');
		$this->category['id'] = (int) $I->createCategory($this->category['name'], '1.6.0');

		$I->comment('I create a product');
		$this->product['name'] = $this->faker->bothify('SiteRedshopbProductImage130CrudCest product ?##?');
