...
class SiteRedshopbProduct120tasksCest
{
	...
	public function taskPublish(Step\Api\redshopb2b $I)
	{
		...
		$product->name  = (string) $this->faker->bothify('SiteRedshopbProduct120tasksCest product ?##?');
		$product->sku  = $this->faker->randomNumber(3);
		$product->category_name = (string) $this->faker->bothify('SiteRedshopbProduct120FilteringCest category ?##?');
		...
		$I->unpublishProduct($product->id, '1.2.0');
		...
		// Clean up
		$I->deleteProduct($product->id, '1.2.0');
	}
	...
	public function taskTagAddandTagRemove(Step\Api\redshopb2b $I)
	{
		...
		$tag1 = new stdClass;
		$tag1->name = $this->faker->bothify('SiteRedshopbProduct120tasksCest tag1 ?##?');
		$tag1->id  = (int) $I->createTag($tag1->name);

		$tag2 = new stdClass;
		$tag2->name = $this->faker->bothify('SiteRedshopbProduct120tasksCest tag2 ?##?');
