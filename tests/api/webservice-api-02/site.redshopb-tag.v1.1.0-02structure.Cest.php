 ...
 */
class SiteRedshopbTag110StructureCest
{
	public function prepare(ApiTester $I)
	{
		$I->wantTo('POST a new tag');
		$this->faker      = Faker\Factory::create();
		$this->name       = $this->faker->bothify('SiteRedshopbTag110StructureCest tag ?##?');
		...
		$I->seeResponseContainsJson(
			[
				'_links'            => [
					'curies'              => [
						0 => [
							'href'      => "$baseUrl/index.php?option=com_redshopb&view=tag&webserviceVersion=1.1.0&webserviceClient=site&format=doc&api=Hal#{rel}",
							'title'     => 'Documentation',
							'name'      => 'redshopb-tag',
							'templated' => true
						]
					...
					'redshopb-tag:list'   => [
						'href' => "$baseUrl/index.php?option=com_redshopb&view=tag&webserviceVersion=1.1.0&webserviceClient=site&api=Hal",
					],
					'redshopb-tag:self'   => [
						'href' => "$baseUrl/index.php?option=com_redshopb&view=tag&webserviceVersion=1.1.0&webserviceClient=site&id=$this->id&api=Hal",
					],
					'redshopb-company'    => [
					...
					'redshopb-parent-tag' => [
						'href'      => "$baseUrl/index.php?option=redshopb&view=tag&webserviceVersion=1.1.0&webserviceClient=site&id=0&api=Hal",
