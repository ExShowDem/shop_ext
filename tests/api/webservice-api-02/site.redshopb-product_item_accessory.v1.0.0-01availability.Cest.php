...
class SiteRedshopbProduct_item_accessory100availabilityCest
{
	public function WebserviceIsAvailable(ApiTester $I)
	{
		...
		$I->sendGET('index.php'
			. '?option=redshopb&view=product_item_accessory'
			. '&api=Hal'
		...
		$I->seeHttpHeader('X-Webservice-name', 'redshopb-product_item_accessory');
