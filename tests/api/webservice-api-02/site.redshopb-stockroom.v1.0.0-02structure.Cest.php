...
class SiteRedshopbStockroom100StructureCest
{
	/**
			...
			[
				'_links' =>
					[
						...
						'redshopb-company' =>
							[
								'href' => "$baseUrl/index.php?option=redshopb-company&webserviceVersion=1.0.0&webserviceClient=site&id=" . $this->stockroom['company_id'] . "&api=Hal",
