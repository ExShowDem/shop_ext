...
class SiteRedshopbTag100TasksCest
{
	...
	public function unpublish(Step\Api\redshopb2b $I)
	{
		...
		$tag = new stdClass;
		$tag->name = (string) $this->faker->bothify('SiteRedshopbTag100TasksCest tag ?##?');
		$tag->id = $I->createTag($tag->name, '1.0.0');
	...
	public function unpublishUnpublishesChildTags(Step\Api\redshopb2b $I)
	{
		...
		$tagParent->name = (string) $this->faker->bothify('SiteRedshopbTag100TasksCest tag ?##?');
		$tagParent->id = $I->createTag($tagParent->name, '1.0.0');

		$tagChild = new stdClass;
		$tagChild->name = (string) $this->faker->bothify('SiteRedshopbTag100TasksCest tag ?##?');
		...
		// Clean up
		$I->deleteTag($tagParent->id, '1.0.0');
	}
	...
	public function publishPublishesChildTags(Step\Api\redshopb2b $I)
	{
		...
		$I->unpublishTag($tagChild->id, '1.0.0');
	...
	public function imageUploadAndImageRemove(Step\Api\redshopb2b $I)
	{
		...
		$tagC['name']  = (string) $this->faker->bothify('SiteRedshopbTag100TasksCest tag with image ?##?');
		$tagC['id'] = (int) $I->createTag($tagC['name'], '1.0.0');
