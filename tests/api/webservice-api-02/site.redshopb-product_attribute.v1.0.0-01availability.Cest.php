...
class SiteRedshopbProduct_attribute100availabilityCest
{
	public function WebserviceIsAvailable(ApiTester $I)
	{
		...
		$I->sendGET('index.php'
			. '?option=redshopb&view=product_attribute'
			. '&api=Hal'
		...
		$I->seeHttpHeader('X-Webservice-name', 'redshopb-product_attribute');
