...
class SiteRedshopbProduct_field_value100availabilityCest
{
	public function WebserviceIsAvailable(ApiTester $I)
	{
		...
		$I->sendGET('index.php'
			. '?option=redshopb&view=product_field_value'
			. '&api=Hal'
		...
		$I->seeHttpHeader('X-Webservice-name', 'redshopb-product_field_value');
