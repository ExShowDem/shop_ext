...
class SiteRedshopbTag100FilteringCest
{
	/**
	...
	public function prepare(Step\Api\redshopb2b $I)
	{
		...
		$this->tagA['name'] = (string) $this->faker->bothify('SiteRedshopbTag100FilteringCest tagA ?##?');
		$this->tagA['id'] = (int) $I->createTag($this->tagA['name'], '1.0.0');

		$I->comment('I create a TagB to be filtered by Type');
		$this->tagB['name']  = (string) $this->faker->bothify('SiteRedshopbTag100FilteringCest tagB ?##?');
		...
		$this->tagC['name']  = (string) $this->faker->bothify('SiteRedshopbTag100FilteringCest tagC ?##?');
		...
		$this->tagD['name']  = (string) $this->faker->bothify('SiteRedshopbTag100FilteringCest tagD ?##?');
		...
		$this->tagE['name']  = (string) $this->faker->bothify('SiteRedshopbTag100FilteringCest tagE ?##?');
		$this->tagE['id'] = (int) $I->createTag($this->tagE['name'], '1.0.0');
		$I->unpublishTag($this->tagE['id'], '1.0.0');
	}
	...
	{
		$I->deleteTag($this->tagA['id'], '1.0.0');
		$I->deleteTag($this->tagB['id'], '1.0.0');
		$I->deleteTag($this->tagC['id'], '1.0.0');
		// $I->deleteTag($this->tagD['id'], '1.0.0');  Already removed when removing the parent TagA
		$I->deleteTag($this->tagE['id'], '1.0.0');
	}
}
