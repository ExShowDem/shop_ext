...
class SiteRedshopbProduct120ErpCest
{
	...
	public function createWithErpId(Step\Api\redshopb2b $I)
	{
		...
		$this->name  = $this->faker->bothify('SiteRedshopbProduct120erpCest product ?##?');
		$this->erpid = $this->faker->numberBetween(1, 9999);
		$this->sku  = $this->faker->randomNumber(3);
		$this->category['name'] = $this->faker->bothify('SiteRedshopbProduct120ErpCest category ?##?');
