...
class SiteRedshopbTag100CrudCest
{
	...
	public function create(ApiTester $I)
	{
		...
		$this->name = $this->faker->bothify('SiteRedshopbTag100CrudCest tag ?##?');
	...
	public function createChild(ApiTester $I)
	{
		...
		$this->name2 = $this->faker->bothify('SiteRedshopbTag100CrudCest tag ?##?');
		$I->amHttpAuthenticated('admin', 'admin');
		$I->sendPOST('index.php'
			. '?option=redshopb&view=tag'
			. '&api=Hal'
	...
	public function delete(ApiTester $I)
	{
		...
		// @todo: the following code will need to be adapted once RSBTB-3152 will be resolved
		$I->sendGET('index.php'
					. '?option=redshopb&view=tag'
					. '&api=Hal'
					. '&webserviceClient=site'
