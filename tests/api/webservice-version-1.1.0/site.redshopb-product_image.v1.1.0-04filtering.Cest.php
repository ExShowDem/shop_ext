...
/**
 * Class SiteRedshopbProductImage110FilteringCest
 * @since 2.8.0
 */
class SiteRedshopbProductImage110FilteringCest
{
	...
	public function prepare(redshopb2b $I)
	{
		...
		$this->category['name'] = $this->faker->bothify('SiteRedshopbProductImage110FilteringCest category ?##?');
		$this->category['id'] = (int) $I->createCategory($this->category['name'], '1.6.0');

		$I->comment('I create a product');
		$this->product['name'] = $this->faker->bothify('SiteRedshopbProductImage110FilteringCest product ?##?');
		...
		$this->productImageA['name'] = $this->faker->bothify('SiteRedshopbProductImage110FilteringCest productImageA ?##?');
		...
		$this->productImageB['name'] = $this->faker->bothify('SiteRedshopbProductImage110FilteringCest productImageB ?##?');
