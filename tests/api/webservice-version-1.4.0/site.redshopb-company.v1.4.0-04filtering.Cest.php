...
class SiteRedshopbCompany140FilteringCest
{
	/**
	...
	public function prepare(Step\Api\redshopb2b $I)
	{
		...
		$this->companyA['name'] = (string) $this->faker->bothify('SiteRedshopbCompany140FilteringCest company ?##?');
		$this->companyA['id'] = (int) $I->createCompany($this->companyA['name'], '1.4.0');

		$I->comment('I create a CompanyB to be filtered by Parent_id (Company A is parent of Company B');
		$this->companyB['name']  = (string) $this->faker->bothify('SiteRedshopbCompany140FilteringCest company ?##?');
		...
		$this->companyC['name']  = (string) $this->faker->bothify('SiteRedshopbCompany140FilteringCest company ?##?');
		...
		$this->companyD['name']  = (string) $this->faker->bothify('SiteRedshopbCompany140FilteringCest company ?##?');
		...
		$this->companyE['name']  = (string) $this->faker->bothify('SiteRedshopbCompany140FilteringCest company ?##?');
		...
		$this->companyF['name']  = (string) $this->faker->bothify('SiteRedshopbCompany140FilteringCest company ?##?');
		...
		$this->companyG['name']  = (string) $this->faker->bothify('SiteRedshopbCompany140FilteringCest company ?##?');
		...
		$this->companyH['name']  = (string) $this->faker->bothify('SiteRedshopbCompany140FilteringCest company ?##?');
		$this->companyH['id'] = (int) $I->createCompany($this->companyH['name'], '1.4.0');
		$I->unpublishCompany($this->companyH['id'], '1.4.0');
	}
	...
	public function cleanUp(Step\Api\redshopb2b $I)
	{
		...
		$I->deleteCompany($this->companyB['id'], '1.4.0');
		$I->deleteCompany($this->companyA['id'], '1.4.0');
		$I->deleteCompany($this->companyC['id'], '1.4.0');
		$I->deleteCompany($this->companyD['id'], '1.4.0');
		$I->deleteCompany($this->companyE['id'], '1.4.0');
		$I->deleteCompany($this->companyF['id'], '1.4.0');
		$I->deleteCompany($this->companyG['id'], '1.4.0');
		$I->deleteCompany($this->companyH['id'], '1.4.0');
	}
}
