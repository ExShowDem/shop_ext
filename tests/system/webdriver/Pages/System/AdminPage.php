...
'Austrlian Parks Add New Menu Item'	=> 'administrator/index.php?option=com_menus&view=item&layout=edit&menutype=parks',
	...
	'Post-installation Messages'	=> 'administrator/index.php?option=com_postinstall',
		...
		'Official Support Forum'	=> 'http://forum.joomla.org/',
			...
			'RedSHOPB2B'	=> 'administrator/index.php?option=com_redshopb&view=categories',
			'RedSHOPB2B_Currency' => 'administrator/index.php?option=com_redshopb&view=currencies',
			'RedSHOPB2B_Company'	=>	'administrator/index.php?option=com_redshopb&view=companies',
			'RedSHOPB2B_User'		=>	'administrator/index.php?option=com_redshopb&view=users',
			'RedSHOPB2B_Department' =>  'administrator/index.php?option=com_redshopb&view=departments',
			'RedSHOPB2B_Product'	=>	'administrator/index.php?option=com_redshopb&view=products',
			'RedSHOPB2B_Wardrobe'	=>	'administrator/index.php?option=com_redshopb&view=wardrobes',
			'RedSHOPB2B_Brand'		=>	'administrator/index.php?option=com_redshopb&view=brands',
			'RedSHOPB2B_Shop'		=>	'administrator/index.php?option=com_redshopb&view=shop',
	);
