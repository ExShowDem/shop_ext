...
class SiteRedshopbCategory100SoapCest
{
	public function _before(ApisoapTester $I)
	{
		$endpoint = $I->getWebserviceBaseUrl()
			. '/administrator/index.php?webserviceClient=site&webserviceVersion=1.0.0&option=redshopb&view=category&api=soap';
	...
	public function create(ApisoapTester $I)
	{
		...
		$this->name  = (string) $this->faker->bothify('SiteRedshopbCategory100SoapCest category ?##?');
