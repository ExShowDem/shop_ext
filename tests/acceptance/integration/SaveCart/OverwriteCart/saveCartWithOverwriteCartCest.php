...
/**
 * Class saveCartWithOverwriteCartCest
 *
...
class saveCartWithOverwriteCartCest
{
	 ...
	 * @since 2.4.1
	 */
	protected $settingCartCheckoutWithOverwriteCart;

	/**
	 * saveCartWithOverwriteCartCest constructor.
	 * @since 2.4.1
	 */
	public function __construct()
	{
		...
		$this->settingCartCheckoutWithOverwriteCart =
			[
				'addToCart' => 'Modal',
				'cartBy' => 'By Quantity',
				'showImageInCart' => 'No',
	...
	public function prepare(redshopb2b $I, \Codeception\Scenario $scenario)
	{
		...
		$I->wantTo('setting Cart Checkout with Save to cart is Overwrite cart');
		$I->settingCartCheckout($this->settingCartCheckoutWithOverwriteCart);
	 ...
	 * @since 2.4.1
	 */
	public function saveCartWithFunctionSaveToCartByOverwriteCart(AdministratorSteps $I, \Codeception\Scenario $scenario)
	{
		$I->doFrontEndLogin($this->employeeWithLogin, $this->employeeWithLogin);
		$I->comment('Test save cart with user login');
		$I->saveCartWithFunctionSaveToCartBy($this->category1, $this->category2, $this->cart, $this->product1, $this->product2, $this->saveToCartBy['Overwrite Cart']);
